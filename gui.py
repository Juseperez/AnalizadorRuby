...
class AnalizadorRubyGUI:
    ...
    def analizar_codigo(self):
        ...
        try:
            ...
            self.root.update()  # Actualizar para mostrar resultados
    ...
    def realizar_analisis_completo(self, codigo):
        ...
        try:
            ...
            if not hasattr(main, 'parser') or main.parser is None:
                resultado += "❌ Error: Parser no disponible en main\n"
                return resultado
            
            # Reinicializar lexer para el análisis sintáctico
            lexer.lineno = 1
            lexer.lexpos = 0
            lexer.input(codigo)
            
            # Ejecutar parser
            resultado_parser = main.parser.parse(codigo, lexer=lexer)
